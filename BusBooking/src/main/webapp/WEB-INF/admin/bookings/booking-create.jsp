...
<c:set var="formAction" value="${contextPath}/admin/bookings/new" scope="request" />
<c:set var="submitLabel" value="Tạo đơn" scope="request" />
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            <h4 class="fw-bold mb-1">Tạo đơn đặt chỗ mới</h4>
                            <span class="text-muted">Nhập thông tin khách và chuyến đi để giữ chỗ.</span>
                        </div>
