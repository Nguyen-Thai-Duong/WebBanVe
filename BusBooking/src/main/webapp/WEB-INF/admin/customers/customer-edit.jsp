                                ...
                                <c:otherwise>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="fullName" name="fullName" value="${customer.fullName != null ? customer.fullName : ''}" pattern="[A-Za-zÀ-ỹà-ỹ\s'.-]{2,100}" title="Chỉ dùng chữ cái và khoảng trắng." required>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value="${customer.phoneNumber != null ? customer.phoneNumber : ''}" inputmode="numeric" pattern="\d{7,20}" title="Chỉ nhập chữ số." required>
                                        </div>
                                        <div class="col-md-6">
