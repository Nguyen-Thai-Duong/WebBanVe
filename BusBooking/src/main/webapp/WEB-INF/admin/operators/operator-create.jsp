...
<head>
    ...
    <title>Thêm người phụ trách</title>
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            <h4 class="fw-bold mb-1">Thêm người phụ trách mới</h4>
                            <span class="text-muted">Tạo tài khoản bus operator để quản lý chuyến đi và phương tiện.</span>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="${contextPath}/admin/operators/new" method="post" class="needs-validation" novalidate>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" inputmode="numeric" pattern="\d{7,20}" title="Chỉ nhập chữ số." required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Số nhà, đường, phường/xã, quận/huyện, tỉnh/thành"></textarea>
                                    </div>
                                    <div class="col-md-6">
