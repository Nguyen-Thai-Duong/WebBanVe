                                    ...
                                    <form action="${contextPath}/admin/operators/edit" method="post" class="needs-validation" novalidate>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="fullName" name="fullName" value="${operator.fullName != null ? operator.fullName : ''}" required>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="phone" name="phone" value="${operator.phoneNumber != null ? operator.phoneNumber : ''}" required>
                                            </div>
                                            <div class="col-md-6">
