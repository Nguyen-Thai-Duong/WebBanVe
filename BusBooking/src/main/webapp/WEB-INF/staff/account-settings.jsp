...
<head>
    ...
    <title>Nhân viên - Cài đặt tài khoản</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                        <div>
                            ...
                            <span class="text-muted">Quản lý thông tin cá nhân và liên hệ của bạn.</span>
                        </div>
                        <% if (!employeeCode.isBlank()) { %>
                            <span class="badge bg-label-warning fs-6">Mã nhân viên: <strong><%= employeeCode %></strong></span>
                        <% } %>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4">
                                ...
                                <hr class="my-0" />
                                <div class="card-body">
                                    <form id="staffAccountSettingsForm" method="post" action="javascript:void(0);">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" placeholder="123 Lê Lợi, Q1" value="<%= address %>" />
                                            </div>
                                            <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <button type="submit" class="btn btn-warning text-white me-2">Lưu thay đổi</button>
